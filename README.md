...
- ConvNeXt-модель **не рекомендуется** полноценно fine-tune'ить — разморозка слоёв сильно падает качество. В процессе оригинальной работы была сохранена лучшая модель. Если вы хотите воспроизвести опыт, для меньшей траты ресурсов вы можете убрать часть кода, отвечающую за разморозку слоёв модели при обучении
